...
<div class="page">
	<ol class="breadcrumb">
		<a href="<?php echo base_url('backend/tooling'); ?>" class="btn btn-round btn-warning"><i class="icon md-format-indent-increase" aria-hidden="true"></i>Ticket List</a>&nbsp;&nbsp;
	</ol>
	<div class="page-header" style="text-align: center; padding: 0px;">
		<h1 class="page-title">Details Form Ticket</h1>
	</div>
								...
								<div class="example-wrap">
									<div class="example">
										...
										<div class="form-group row form-material row">
											...
											<div class="col-md-6">
                                                <input type="radio" class="ApprovStatus" id="Acceptance" required <?php if($get_row_ticket->status == "2" || $get_row_ticket->action == "On-Progress" ) {echo "checked";}?> onclick="return false;">&ensp;<label class="badge badge-warning" style="font-size: 13px;" for=" ">Acceptance</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group row showprogress" style="display:none;">
                                                ...
                                                <div class="col-md-8">
                                                    <input id="DatePro" type="datetime-local" class="form-control" autocomplete="off" <?php if(!empty($date_progress)){ echo "value='$date_progress'";} ?> readonly/>
                                                </div> 
                                            </div>
                                            <!-- ## Date Discussion ##-->
                                            <div class="form-group row showdiscuss" style="display:none;">
                                                ...
                                                <div class="col-md-8">
                                                    <input id="DateDisc" type="datetime-local" class="form-control" autocomplete="off" <?php if(!empty($date_discuss)){ echo "value='$date_discuss'";} ?> readonly/>
                                                </div>
                                            </div>
                                        </div>
								...
								<div class="example-wrap">
									<div class="example">
										...
										<div class="form-group row form row">
											...
											<div class="col-md-7">
												<textarea class="maxlength-textarea form-control" name="feedback"
													...
													maxlength="100" rows="2" placeholder="FeedBack" value="<?=$get_row_ticket->feedback?>" disabled> <?=$get_row_ticket->feedback?></textarea>
											</div>
										</div>
                                        ...
                                        <div class="form-group row showprogress" style="display:none;">
                                            ...
                                            <div class="col-md-6">
                                                <textarea id="TextPro" class="maxlength-textarea form-control" data-plugin="maxlength" data-placement="bottom-right-inside" maxlength="100" rows="2" placeholder="Progress" readonly><?=$get_row_ticket->progress?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row showdiscuss" style="display:none;">
											...
											<div class="col-md-6">
												<input id="TextDiss" type="text" class="form-control" placeholder="Text Message" <?php if(!empty($get_row_ticket->message)){ echo "value='$get_row_ticket->message'";} ?> readonly>
											</div>
										</div>
										...
										<div class="form-group row showprogress" style="display:none;">
                                            ...
                                            <div class="col-md-6">
												<input type="radio" class="ClosedTicket" value="5" onclick="return false;" id="ClosedT" <?php if($get_row_ticket->status == "5") {echo "checked";}?>>&ensp;<label class="badge badge-info" style="font-size: 14px;" for="ClosedT">Closed Ticket</label>
                                            </div>
                                        </div>
