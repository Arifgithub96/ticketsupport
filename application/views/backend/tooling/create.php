							...
							<div class="col-md-12 col-lg-6">
								...
								<div class="example-wrap">
									<div class="example">
										...
										<?= form_open(base_url('backend/tooling/create'),  'id="login_validation" enctype="multipart/form-data"') ?>
										...
										<div class="form-group row">
											<label class="col-md-3 form-control-label"><b>Title</b><b
													style="color: red;">*</b> : </label>
											<div class="col-md-6">
											<input type="text" class="form-control" name="title" required placeholder="Text Title">
											</div>
										</div>
