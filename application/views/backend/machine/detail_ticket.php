								...
								<div class="example-wrap">
									<div class="example">
										...
										<div class="form-group row form-material row">
											...
											<div class="col-md-6">
                                                <input type="radio" class="ApprovStatus" id="Acceptance" required <?php if($get_row_ticket->status != '3' && $get_row_ticket->status != '1') {echo "checked";}?> onclick="return false;">&ensp;<label class="badge badge-warning" style="font-size: 13px;" for=" ">Acceptance</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
