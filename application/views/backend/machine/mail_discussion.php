...
<tr>
  <td>
    ...
    <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td bgcolor="#40bf80" class="header">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="h2" style="color: #e68a00;">
                ...
                Dear, <?=$name_req;?> - (<?=$desc_req;?>) your request ticket must be discussed first, schedule a discussion :
              </td>
            </tr>
            <tr>
              <td class="bodycopy">
              <b>Date : <?=$date_discuss;?></b>
              </td>
            </tr>
            <tr>
              <td class="bodycopy">
                ...
                <table width="130%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td style="padding: 20px 0 0 0;">
                      <i style="color: #1ac6ff;">Click here to go to ticket support</i>
      ...
      <tr>
        <td class="footer" bgcolor="#26734d">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
