							...
							<div class="col-md-12 col-lg-6">
								...
								<div class="example-wrap">
									<div class="example">
										...
										<?= form_open(base_url('backend/machine/progress'),  'id="login_validation" enctype="multipart/form-data"') ?>
										...
										<?=$get_row_ticket->reason_reject;?>
										<div class="form-group row form-material row">
											<label class="col-md-3 form-control-label">Approval<b style="color: red;">*</b> : </label>
											<div class="col-md-6">
                                                <input type="radio" class="ApprovStatus" id="Acceptance" required <?php if($get_row_ticket->status != '3') {echo "checked";}?> onclick="return false;">&ensp;<label class="badge badge-warning" style="font-size: 13px;" for=" ">Acceptance</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group row showprogress" style="display:none;">
                                                ...
                                                <div class="col-md-8">
                                                    <input id="DatePro" type="datetime-local" name="date_progress" class="form-control" autocomplete="off" <?php if(!empty($date_progress)){ echo "value='$date_progress'";}else{ echo" ";} ?>/>
                                                </div> 
                                            </div>
                                            <!-- ## Date Discussion ##-->
