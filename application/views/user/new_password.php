...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <title>Kementrian PPN/Bappenas</title>
  ...
  <body class="animsition page-forgot-password layout-full">
    ...
    <div class="page vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">
      <div class="page-content vertical-align-middle">
        ...
        <h1 style="color: #005ce6;"><b>Kementrian PPN/Bappenas</b></h1>
        <!-- <h4><b>Forgot Your Password ?</b></h4> -->
        <!-- <p><b>Input your email</b></p> -->
        <div class="form-group row">
            <!-- <label class="col-md-3 form-control-label"><b>Picture</b></label> -->
            <div class="col-md-12">
                <?php if (!empty($photo->file_picture)) { ?>
                    <img id="myImg" src="<?php echo base_url('src/assets/images/profile/'.$photo->file_picture); ?>" alt="Paris" width="150" height="150">
                <?php }else{ ?>
                    <img src="<?php echo base_url('src/assets/images/profile/avatar2.jpg'); ?>" alt="Paris" width="150" height="150" class="profil">
                <?php } ?>
                <p><b><?=$email;?></b></p>
            </div>
        </div>
        ...
        <?php echo form_open("auth/set_new_password");?>
          <div class="form-group form-material floating" data-plugin="formMaterial">
            <h5><b>Code Verification</b></h5>
            <input type="text" class="form-control empty place-holder-center" id="code" name="confirm_code" placeholder="xx-xx">

            <h5><b>New Password</b></h5>
            <input type="password" class="form-control empty password" minlength="6" id="passwordEmail" name="password" placeholder="password">
          </div>
        ...
        <footer class="page-copyright">
          ...
          <p>© <?=date("Y")?>. Kementrian PPN/Bappenas</p>
          <!-- <div class="social">
