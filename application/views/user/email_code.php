...
<head>
  ...
  <title>Email Confirm Code</title>
  <style type="text/css">
      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="h2">
                You got a message from Kementrian PPN/Bappenas
              </td>
            </tr>
            <tr>
              <td class="bodycopy">
                If you don't change your password, please report it to the admin !
              </td>
            </tr>
          </table>
        </td>
            ...
            <tr>
              <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="bodycopy">
                      <b>Hi, <?=$email;?> you have received a confirmation code :</b>
                    </td>
                  </tr>
                  <tr>
                      ...
                      <table class="buttonwrapper" bgcolor="#e05443" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td class="button" height="45">
                            ...
                            <a style="color: white;" ><b style="color:white;"><?=$hasil_code;?></b></a>
                          </td>
                        </tr>
                      </table>
                    </td>
